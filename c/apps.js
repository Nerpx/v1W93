        ...
        exec: function() {
            ...
            function createSelector(what, fn) {
                ...
                var effect = $el.create('select', null, {
                        ...
                        $el.create('option', '--- effects ---', {
                            value: ''
                        }),
                        $el.create('option', 'none', {
                            value: ''
                        }),
                        $el.create('option', 'acid', {
                            value: 'ef_acid'
                        }),
                        $el.create('option', 'blur', {
                            value: 'ef_blur'
                        }),
                        $el.create('option', 'invert', {
                            value: 'ef_invert'
                        }),
                        $el.create('option', 'edge', {
                            value: 'ef_edge'
                        }),
                        $el.create('option', 'zombi', {
                            value: 'ef_zombi'
                        }),
                        $el.create('option', 'emboss', {
                            value: 'ef_emboss'
                        }),
                        $el.create('option', 'xray', {
                            value: 'ef_xray'
                        }),
                        $el.create('option', 'turbulence', {
                            value: 'ef_turbulence'
                        }),
                        $el.create('option', 'glitch', {
                            value: 'ef_glitch'
                        }),
                        $el.create('option', 'spectrum', {
                            value: 'ef_spectrum'
                        }),
                        $el.create('option', 'Volvo', {
                            value: 'volvo'
                        }),
                        $el.create('option', 'Saab', {
                            value: 'saab'
                        }),
                        $el.create('option', 'Mercedes', {
                            value: 'mercedes'
                        }),
                        $el.create('option', 'Audi', {
                            value: 'audi'
                        })
                    ],
                    truc
    ...
    "fx": {
        ...
        exec: function(name) {
            ...
            var effects = {
                ...
                'invertLight': function() {
                    repaint('ef_invert_light')
                },
                'grayscale': function() {
                    repaint('ef_grayscale')
                },
                'xray': function() {
                    repaint('ef_xray')
                },
